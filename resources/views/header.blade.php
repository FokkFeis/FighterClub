            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href='{!! url('fights/fighters') !!}'>Fighters</a>
                    <a class="dropdown-item" href='{!! url('fights/leaderboard') !!}'>Fighter Leaderboards</a>
                    <?php if(isset($_SESSION['username'])){?>
                      <a class="dropdown-item" href='{!! url('home/userStats') !!}'>My stats</a>
                    <?php } ?>
                  </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href='{!! url('fights/arena') !!}'>Arena</a>
                </li>
            </ul>
        </div>
    </nav>
                  ...
                  <ul class="list-group list-group-flush">
                    <?php if(isset($_SESSION['username'])){
                        ...
                        <div class="btn-group-vertical" role="group">
                          <a class="btn btn-outline-primary" href='{!! url('home/account') !!}'>My Account</a>
                          <?php if ($_SESSION['isAdmin'] === '1') {?>
                            <a class="btn btn-outline-danger" href='{!! url('home/admin') !!}'>Admin Zone</a>
                            <?php }?>
                            <a class="btn btn-outline-danger" href='{!! url('home/signout') !!}'>Signout</a>
                        </div>
                          <?php } else{ ?>
